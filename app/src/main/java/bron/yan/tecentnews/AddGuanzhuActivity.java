...
public class AddGuanzhuActivity extends FragmentActivity {
    ...
    private void initView() {
        ...
        fragmentTransaction.replace(R.id.framelayout_guanzhu_detail, new GuanzhuPaiHangFragment());
        ...
        listViewFenzu.setAdapter(new Guanzhufenzu_Listview_Adapter(AddGuanzhuActivity.this, fenzuList));
        listViewFenzu.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Log.i("onItemSelected", "select " + position);
        ...
        listViewFenzu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.i("onItemClick", "click " + position);
                view.setBackgroundColor(Color.GRAY);
            }
        });

        listViewFenzu.setSelection(0);
